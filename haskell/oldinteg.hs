...
derive (Mult 1 x1 x2 1) = Sum 1 (Mult 1 (derive x1) x2 1) (Mult 1 x1 (derive x2) 1) 1
--derive (Mult a x1 x2 n) = 
...
derive (Sec a x 1) = Mult 1 (Mult 1 (Tan a x 1) (Sec a x 1) 1) (derive x) 1
derive (Csc a x 1) = Mult 1 (Mult 1 (Cot a x 1) (Csc (-a) x 1) 1) (derive x) 1
